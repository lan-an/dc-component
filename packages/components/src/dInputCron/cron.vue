    ...
    <div class="vue3-cron-div">
      <el-tabs type="border-card" v-model="activeTab">
        <el-tab-pane name="second">
          ...
          <div class="tabBody myScroller" :style="{ 'max-height':  config.maxHeight }">
            ...
            <el-row>
              <el-radio class="long" v-model="state.second.cronEvery" label="3" :disabled="disabled">{{
                ...
                <el-select @click.prevent placeholder="请选择" size="small" multiple v-model="state.second.specificSpecific" :disabled="disabled">
          ...
          <div class="tabBody myScroller" :style="{ 'max-height':  config.maxHeight }">
            ...
            <el-row>
              <el-radio class="long" v-model="state.minute.cronEvery" label="3" :disabled="disabled">{{
                ...
                <el-select @click.prevent placeholder="请选择" size="small" multiple v-model="state.minute.specificSpecific" :disabled="disabled">
                  <el-option v-for="(val, index) in 60" :key="index" :value="val - 1">{{ val - 1 }}</el-option>
                </el-select>
              </el-radio>
            </el-row>
          ...
          <div class="tabBody myScroller" :style="{ 'max-height':  config.maxHeight }">
            ...
            <el-row>
              <el-radio class="long" v-model="state.hour.cronEvery" label="3" :disabled="disabled">{{
                ...
                <el-select @click.prevent placeholder="请选择" size="small" multiple v-model="state.hour.specificSpecific" :disabled="disabled">
          ...
          <div class="tabBody myScroller" :style="{ 'max-height':  config.maxHeight }">
            ...
            <el-row>
              <el-radio v-model="state.day.cronEvery" label="2" :disabled="disabled">{{ state.text.Day.intervalWeek[0] }}
                ...
                <el-select @click.prevent placeholder="请选择" size="small" v-model="state.week.incrementStart" :disabled="disabled">
            ...
            <el-row>
              <el-radio class="long" v-model="state.day.cronEvery" label="4" :disabled="disabled">{{
                ...
                <el-select @click.prevent placeholder="请选择" size="small" multiple v-model="state.week.specificSpecific" :disabled="disabled">
            ...
            <el-row>
              <el-radio class="long" v-model="state.day.cronEvery" label="5" :disabled="disabled">{{
                ...
                <el-select @click.prevent placeholder="请选择" size="small" multiple v-model="state.day.specificSpecific" :disabled="disabled">
            ...
            <el-row>
              <el-radio v-model="state.day.cronEvery" label="8" :disabled="disabled">{{ state.text.Day.lastWeek[0] }}
                <el-select @click.prevent placeholder="请选择" size="small" v-model="state.day.cronLastSpecificDomDay" :disabled="disabled">
                  <el-option v-for="(val, index) in 7" :key="index" :label="state.text.Week[val - 1]" :value="val">
                  </el-option>
                </el-select>
            ...
            <el-row>
              <el-radio v-model="state.day.cronEvery" label="11" :disabled="disabled">{{ state.text.Day.someWeekday[0] }}
                ...
                <el-select @click.prevent placeholder="请选择" size="small" v-model="state.week.cronNthDayDay" :disabled="disabled">
                  <el-option v-for="(val, index) in 7" :key="index" :label="state.text.Week[val - 1]" :value="val">
                  </el-option>
                </el-select>
          ...
          <div class="tabBody myScroller" :style="{ 'max-height':  config.maxHeight }">
            ...
            <el-row>
              <el-radio class="long" v-model="state.month.cronEvery" label="3" :disabled="disabled">{{
                ...
                <el-select @click.prevent placeholder="请选择" size="small" multiple v-model="state.month.specificSpecific" :disabled="disabled">
          ...
          <div class="tabBody myScroller" :style="{ 'max-height':  config.maxHeight }">
            ...
            <el-row>
              <el-radio v-model="state.year.cronEvery" label="2" :disabled="disabled">{{ state.text.Year.interval[0] }}
                ...
                <el-input-number size="small" v-model="state.year.incrementStart" :min="startYear" :max="2118"
                  :disabled="disabled"></el-input-number>
              </el-radio>
            </el-row>
            <el-row>
              <el-radio class="long" v-model="state.year.cronEvery" label="3" :disabled="disabled">{{
                ...
                <el-select @click.prevent placeholder="请选择" size="small" filterable multiple v-model="state.year.specificSpecific" :disabled="disabled">
                  <el-option v-for="(val, index) in 100" :key="index" :label="startYear + index" :value="startYear + index"></el-option>
                </el-select>
              </el-radio>
            </el-row>
            <el-row>
              <el-radio v-model="state.year.cronEvery" label="4" :disabled="disabled">{{ state.text.Year.cycle[0] }}
                <el-input-number size="small" v-model="state.year.rangeStart" :min="startYear" :max="2118"
                  :disabled="disabled"></el-input-number>
                {{ state.text.Year.cycle[1] }}
                <el-input-number size="small" v-model="state.year.rangeEnd" :min="startYear" :max="2118" :disabled="disabled">
                </el-input-number>
              </el-radio>
            </el-row>
          </div>
      ...
      <div class="bottom">
        ...
        <div class="buttonDiv">
          <el-button type="primary" size="default" @click.stop="handleChange" :disabled="disabled">{{ state.text.Save }}
          </el-button>
          <el-button  size="default" @click="close">{{ state.text.Close }}</el-button>
        </div>
      </div>
    </div>
  </template>
  <script setup name="DCron" lang="ts">
  ...
  const state = reactive({
    ...
    yearsText: computed({
      ...
      set: (value) => {
        ...
        if (value.includes(',') || (value.length > 0 && !Number.isNaN(Number(value)) && Number(value) <= 2118 && Number(value) >= startYear)) {
