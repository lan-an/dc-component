          ...
          <el-radio-group v-model="state.second.cronEvery">
            <el-row>
              <el-radio
                ...
                label="1"
                :disabled="disabled"
                >{{ state.text.Seconds.every }}</el-radio
              >
            </el-row>
            <el-row>
              <el-radio
        ...
        >
          <el-row>
            <el-radio
              ...
              label="1"
              :disabled="disabled"
              >{{ state.text.Minutes.every }}</el-radio
            >
          </el-row>
          <el-row>
            <el-radio
        ...
        >
          <el-row>
            <el-radio
              ...
              label="1"
              :disabled="disabled"
              >{{ state.text.Hours.every }}</el-radio
            >
          </el-row>
          <el-row>
            <el-radio
        ...
        >
          ...
          <el-row>
            <el-radio
              ...
              label="6"
              :disabled="disabled"
              >{{ state.text.Day.lastDay }}</el-radio
            >
          </el-row>
          <el-row>
            <el-radio
              ...
              label="7"
              :disabled="disabled"
              >{{ state.text.Day.lastWeekday }}</el-radio
            >
          </el-row>
          <el-row>
            <el-radio
        ...
        >
          <el-row>
            <el-radio
              ...
              label="1"
              :disabled="disabled"
              >{{ state.text.Month.every }}</el-radio
            >
          </el-row>
          <el-row>
            <el-radio
        ...
        >
          <el-row>
            <el-radio
              ...
              label="1"
              :disabled="disabled"
              >{{ state.text.Year.every }}</el-radio
            >
          </el-row>
          <el-row>
            <el-radio
